...
public class WeatherForecastOpenHelper extends SQLiteOpenHelper {
    ...
    public static final String CREATE_COUNTY="create table Country(id integer primary key autoincrement,country_name text,country_code text,city_id integer)";
